...
function AddPlanet() {
    ...
    // Functions to post planet to database when submit button is clicked
    ...
    // Function to cancel adding a planet
    ...
    return (
        ...
        <div className="form-container">
            <h1 className="main-heading">Create Planet</h1>
            <form onSubmit={handleSubmit} className="form">
                ...
                <div className="form-button-container">
                    <input type="submit" value="Submit" className="modify-button" />
                    <button
                        type="button"
